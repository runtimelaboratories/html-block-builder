...
//#region node_modules/grapesjs-plugin-forms/dist/index.js
var require_dist = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	(function(e, t) {
		...
		const m = function(e, t) {
			...
			(function(e) {
				var t = e.Components, d = { name: "name" }, u = { name: "placeholder" }, m = {
					type: "checkbox",
					name: "required"
				}, h = function(e, t) {
					return {
				...
				t.addType(n, {
					...
					view: { updateAttributes: function() {
					...
					model: {
						...
						init: function() {
							var e = this.components(), t = 1 === e.length && e.models[0], n = t && t.is("textnode") && t.get("content") || "", o = n || this.get("text");
					...
					getInputEl: function() {
						if (!this.$input) {
							for (var e = [], t = this.target.components(), n = 0; n < t.length; n++) {
								var o = t.models[n], a = o.get("attributes"), i = (null == a ? void 0 : a.value) || "", s = o.components().models[0], r = s && s.get("content") || "";
