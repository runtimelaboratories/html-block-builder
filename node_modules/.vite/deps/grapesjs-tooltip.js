...
//#region node_modules/grapesjs-tooltip/dist/index.js
	...
	(function(t, e) {
		...
		var n = function() {
			return n = Object.assign || function(t) {
				for (var e, n = 1, o = arguments.length; n < o; n++) for (var a in e = arguments[n]) Object.prototype.hasOwnProperty.call(e, a) && (t[a] = e[a]);
				return t;
		...
		const o = function(t, e) {
			...
			}, e), r = a.propsTooltip, l = a.classTooltip, i = a.style, c = a.styleAdditional, s = a.privateClasses, p = a.stylableTooltip, d = a.showTooltipOnStyle, f = a.blockTooltip, m = a.extendTraits, u = a.id, b = a.labelTooltip, h = a.attrTooltip;
					...
					defaults: n({
						...
						traits: m([
							...
							},
							{
								...
								command: function(t) {
									var e;
									t.Panels.getButton("views", "open-sm")?.set("active", !0);
									var o = t.Css.getRules(".".concat(v))[0];
									if (o.set("stylable", p), t.StyleManager.select(o), d) {
										var a = t.getSelected();
										null != a && a.is(u) && (a.addAttributes(((e = {})[y] = "true", e)), t.once("style:target", (function() {
											var t;
