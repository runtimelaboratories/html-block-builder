...
//#region node_modules/grapesjs-tabs/dist/grapesjs-tabs.min.js
var require_grapesjs_tabs_min = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/*! grapesjs-tabs - 1.0.6 */
	(function(t, e) {
		...
		return function(t) {
			...
			function(t, e, n) {
				...
				var b = function(t, e) {
					var n = e.defaultModel, r = e.typeTabs, a = e.selectorTab, i = (e.editor, c()(e, [
						"defaultModel",
						"typeTabs",
						"selectorTab",
						"editor"
					]));
					t.addType(i.typeTab, { model: {
						defaults: s({
							name: "Tab",
				...
				var u = function(t, e) {
					var n = e.typeTab, r = e.typeTabContent, o = e.typeTabContents, a = e.typeTabContainer, i = e.style, s = c()(e, [
						"typeTab",
						"typeTabContent",
						"typeTabContents",
						"typeTabContainer",
				...
				var d = function(t, e) {
					t.addType(e.typeTabContent, { model: { defaults: y({
						name: "Tab Content",
						draggable: !1,
						copyable: !1,
						removable: !1,
				...
				var j = function(t, e) {
					t.addType(e.typeTabContents, { model: { defaults: g({
						name: "Tab Contents",
						draggable: !1,
						droppable: !1,
						copyable: !1,
				...
				var T = function(t, e) {
					t.addType(e.typeTabContainer, { model: { defaults: v({
						name: "Tab Container",
				...
				var w = function(t) {
					var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = t.DomComponents, r = P(P({}, e), {}, {
